...
import { isDevice, usePrevious } from "./helper";
...
const Cursor = React.forwardRef<CursorRef, CursorProps>((props, ref) => {
    ...
    React.useEffect(() => {
        ...
        if (isActiveClickable) {
            cursorInner.style.transform = `translate(-50%, -50%) scale(${
                innerScale * 1.2
            })`;
            cursorOuter.style.transform = `translate(-50%, -50%) scale(${
                outerScale * 1.4
            })`;
        }
