    ...
    return (
        <div className="flex flex-col h-screen">
            <div className="flex flex-grow">
                <Sidebar />
                <div className="bg-[#1f2428] border-r border-gray-600 text-white w-[337px]">
                    <Paths />
                </div>
                <div className="bg-[#24292f] flex-grow flex flex-col text-white">
                    ...
                    <div className="flex-grow border-t flex flex-col border-gray-600">
                        <div className="bg-content bg-no-repeat bg-cover flex flex-col p-8 space-y-5 flex-grow text-lg">
